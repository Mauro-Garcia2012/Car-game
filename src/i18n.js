...
const STRINGS = {
  en: {
    ...
    'spec.noFreight': 'No freight — nowhere to put it, until you fit a rack',
    ...
    'shop.rack': 'Rack and panniers — carry freight',
    ...
    'msg.bought.rack': 'RACK AND PANNIERS ON — {cost}\nIT CAN CARRY FREIGHT NOW',
    ...
    'msg.caseRack': 'A RACK AND PANNIERS, OF ALL THINGS\nIT CAN CARRY FREIGHT NOW',
  ...
  es: {
    ...
    'spec.noFreight': 'Sin carga — no hay dónde meterla, hasta que le pongas baca',
    ...
    'shop.rack': 'Baca y alforjas — poder llevar carga',
    ...
    'msg.bought.rack': 'BACA Y ALFORJAS MONTADAS — {cost}\nYA PUEDE LLEVAR CARGA',
    ...
    'msg.caseRack': 'UNA BACA CON ALFORJAS, MIRA TÚ\nYA PUEDE LLEVAR CARGA',
