...
const STRINGS = {
  en: {
    ...
    'hud.bodyshop': 'Body shop',
    'hud.bodyDamage': 'Damage',
    'hud.bodyCost': 'Beating it out',
    'hud.bodyFix': 'PRESS E — FIX IT',
    'hud.bodyPart': 'PRESS E — FIX WHAT YOU CAN',
    ...
    'msg.bodyFixed': 'PANELS BEATEN STRAIGHT — {cost}',
    'msg.bodyPart': 'PATCHED UP FOR {cost} — STILL {left} BENT',
    'msg.bodyBroke': 'NOT A DOLLAR FOR THE BODYWORK — {cost} TO PUT IT RIGHT',
  ...
  es: {
    ...
    'hud.bodyshop': 'Taller de chapa',
    'hud.bodyDamage': 'Daños',
    'hud.bodyCost': 'Sacar los golpes',
    'hud.bodyFix': 'PULSA E — ARREGLARLO',
    'hud.bodyPart': 'PULSA E — LO QUE PUEDAS PAGAR',
    ...
    'msg.bodyFixed': 'CHAPA ENDEREZADA — {cost}',
    'msg.bodyPart': 'APAÑADO POR {cost} — TE QUEDA UN {left} DE DAÑOS',
    'msg.bodyBroke': 'NI UN DÓLAR PARA LA CHAPA — {cost} CUESTA ARREGLARLA',
