...
const STRINGS = {
  en: {
    ...
    'msg.trackAhead': 'DIRT TRACK AHEAD — SOMETHING OUT THERE',
    ...
    'msg.caseKeys': 'KEYS IN THE BRIEFCASE — {name} IS YOURS',
  ...
  es: {
    ...
    'msg.trackAhead': 'CAMINO DE TIERRA — ALGO HAY AHÍ FUERA',
    ...
    'msg.caseKeys': 'LLAVES EN EL MALETÍN — {name} ES TUYO',
